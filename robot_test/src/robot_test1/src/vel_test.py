...
def talker():
	...
	while not rospy.is_shutdown():
		...
		hello_str.points=[
				JointTrajectoryPoint(velocities=(0,0,0,0,0.3,0),accelerations=(0,0,0,0,0.1,0),time_from_start=rospy.Duration(0.5)),
				JointTrajectoryPoint(velocities=(0,0,0,0,0,0.1),accelerations=(0,0,0,0,0,0.1),time_from_start=rospy.Duration(1)),
				JointTrajectoryPoint(velocities=(0,0,0,0,0.2,0),accelerations=(0,0,0,0.1,0,0),time_from_start=rospy.Duration(2))]
		theta=theta+1.0/125
