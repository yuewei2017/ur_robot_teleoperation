...
//    as_ = actionlib::ActionServeractionlib::ActionServer<control_msgs::FollowJointTrajectoryAction>(
//          nh_, joint_prefix +"follow_joint_trajectory",
//                                   boost::bind(&RosWrapper::goalCB, this, _1),
//                                   boost::bind(&RosWrapper::cancelCB, this, _1), false);
      ...
      speed_sub_ = nh_.subscribe(joint_prefix+"ur_driver/joint_speed", 1,
					&RosWrapper::speedInterface, this);
      urscript_sub_ = nh_.subscribe(joint_prefix+"ur_driver/URScript", 1,
					&RosWrapper::urscriptInterface, this);

      io_srv_ = nh_.advertiseService(joint_prefix+"ur_driver/set_io",
					&RosWrapper::setIO, this);
      payload_srv_ = nh_.advertiseService(joint_prefix+"ur_driver/set_payload",
...
private:
    ...
    ros::param::get("~prefix", joint_prefix);
        ...
        joint_prefix+"joint_states", 1);
		ros::Publisher wrench_pub = nh_.advertise<geometry_msgs::WrenchStamped>(
        joint_prefix+"wrench", 1);
        ros::Publisher tool_vel_pub = nh_.advertise<geometry_msgs::TwistStamped>(joint_prefix+"tool_velocity", 1);
    ...
    ros::param::get("~prefix", joint_prefix);
        ...
        joint_prefix+"ur_driver/io_states", 1);
