...
(cl:defmethod cl:initialize-instance :after ((m <falconPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'falconPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_test1-msg:<falconPos> is deprecated: use robot_test1-msg:falconPos instead.")))
